...
exports.ORCHESTRATION_TOOLS = exports.checkoutWithDiscountsTool = exports.planTripTool = exports.placeOrderWithLoyaltyTool = exports.planDinnerDateTool = exports.bookHotelWithPreferencesTool = void 0;
 ...
 */
exports.bookHotelWithPreferencesTool = {
    ...
    execute: async (params, context) => {
        try {
            ...
            logger_1.logger.info('[Orchestration] Booking hotel', { location: params.location });
            ...
            logger_1.logger.error('[Orchestration] book_hotel_with_preferences failed', { error: error.message });
...
exports.planDinnerDateTool = {
    ...
    execute: async (params, context) => {
        try {
            ...
            logger_1.logger.info('[Orchestration] Searching restaurants', { cuisine: params.cuisine });
            const restaurant = {
                id: `rest_${Date.now()}`,
            ...
            logger_1.logger.error('[Orchestration] plan_dinner_date failed', { error: error.message });
            return { success: false, error: error.message };
        }
    }
};
 ...
 */
exports.placeOrderWithLoyaltyTool = {
    ...
    execute: async (params, context) => {
        try {
            ...
            const currentPoints = context.preferences?.['karmaPoints'] || 0;
            const maxRedeemable = Math.min(currentPoints, 500);
            // Step 2: Calculate discount
            const pointsToUse = params.usePoints || maxRedeemable;
            ...
            logger_1.logger.error('[Orchestration] place_order_with_loyalty failed', { error: error.message });
            return { success: false, error: error.message };
        }
    }
};
...
exports.planTripTool = {
    ...
    execute: async (params, context) => {
        try {
            ...
            logger_1.logger.info('[Orchestration] Searching hotels', { destination: params.destination });
            const checkOutDate = String(params.checkOut).split('-');
            const checkInDate = String(params.checkIn).split('-');
            const nights = parseInt(checkOutDate[2]) - parseInt(checkInDate[2]);
            const hotels = [
            ...
            const interests = params.interests || ['beaches', 'food'];
            const activities = [
            ...
            const activitiesTotal = activities.reduce((sum, a) => sum + a.price, 0);
            ...
            logger_1.logger.error('[Orchestration] plan_trip failed', { error: error.message });
            return { success: false, error: error.message };
        }
    }
};
 ...
 */
exports.checkoutWithDiscountsTool = {
    ...
    execute: async (params, context) => {
        try {
            ...
            // Apply points
            const pointsToUse = params.usePoints || 0;
            if (pointsToUse) {
                pointsDiscount = Math.min(pointsToUse / 10, subtotal - couponDiscount);
            }
            // Apply coins
            const coinsToUse = params.useCoins || 0;
            if (coinsToUse) {
            ...
            logger_1.logger.error('[Orchestration] checkout_with_discounts failed', { error: error.message });
            return { success: false, error: error.message };
        }
    }
};
// ── All Orchestration Tools Export ─────────────────────────────────────────────
exports.ORCHESTRATION_TOOLS = [
    exports.bookHotelWithPreferencesTool,
    exports.planDinnerDateTool,
    exports.placeOrderWithLoyaltyTool,
    exports.planTripTool,
...
exports.default = exports.ORCHESTRATION_TOOLS;
