...
exports.UnifiedKnowledgeBase = exports.CustomerKnowledgeProvider = exports.MerchantKnowledgeProvider = exports.AppKnowledgeProvider = exports.IndustryKnowledgeProvider = exports.GlobalKnowledgeProvider = exports.INDUSTRY_CATEGORIES = void 0;
exports.createKnowledgeBase = createKnowledgeBase;
exports.getKnowledgeForIndustry = getKnowledgeForIndustry;
exports.getKnowledgeForAppType = getKnowledgeForAppType;
// ── Industry Category Mapping ─────────────────────────────────────────────────
exports.INDUSTRY_CATEGORIES = {
...
class GlobalKnowledgeProvider {
    type = 'global';
    priority = 1;
    async getEntries(_context) {
        return GLOBAL_KNOWLEDGE;
    }
}
exports.GlobalKnowledgeProvider = GlobalKnowledgeProvider;
// ── Hotel & Travel Knowledge ────────────────────────────────────────────────
const HOTEL_TRAVEL_KNOWLEDGE = [
    {
        id: 'hotel:check-in',
        type: 'service',
...
const FASHION_BEAUTY_KNOWLEDGE = [
    {
...
const GROCERY_ESSENTIALS_KNOWLEDGE = [
    {
        id: 'grocery:delivery',
        type: 'service',
...
const PHARMACY_HEALTHCARE_KNOWLEDGE = [
    {
...
const ENTERTAINMENT_EVENTS_KNOWLEDGE = [
    {
...
const TRAVEL_EXPERIENCES_KNOWLEDGE = [
    {
        id: 'travel:deals',
        type: 'offer',
        title: 'Travel Deals',
...
const FITNESS_SPORTS_KNOWLEDGE = [
    {
        id: 'fitness:classes',
        type: 'service',
...
const EDUCATION_LEARNING_KNOWLEDGE = [
    {
...
const FINANCIAL_SERVICES_KNOWLEDGE = [
    {
        id: 'financial:coins',
        type: 'info',
        title: 'ReZ Coins',
...
class IndustryKnowledgeProvider {
    appType;
    industryCategory;
    type = 'industry';
    priority = 2;
    constructor(appType, industryCategory) {
...
exports.IndustryKnowledgeProvider = IndustryKnowledgeProvider;
// ── Legacy App Knowledge Provider (backward compatible) ────────────────────
class AppKnowledgeProvider {
    appType;
    type = 'app';
    priority = 2;
    constructor(appType) {
...
exports.AppKnowledgeProvider = AppKnowledgeProvider;
class MerchantKnowledgeProvider {
    merchantData;
    type = 'merchant';
    priority = 3;
...
exports.MerchantKnowledgeProvider = MerchantKnowledgeProvider;
// ── Customer Knowledge Provider ─────────────────────────────────────────────
class CustomerKnowledgeProvider {
    customerContext;
    type = 'customer';
    priority = 4;
    constructor(customerContext) {
    ...
    async getEntries(_context) {
        ...
        if (this.customerContext.recentOrders && this.customerContext.recentOrders.length > 0) {
            const orderSummary = this.customerContext.recentOrders.slice(0, 3).map(o => `${o.type.replace('_', ' ')} - ${o.status} - $${o.total.toFixed(2)}`).join('; ');
            entries.push({
...
exports.CustomerKnowledgeProvider = CustomerKnowledgeProvider;
// ── Unified Knowledge Base ──────────────────────────────────────────────────
class UnifiedKnowledgeBase {
    providers;
    constructor(globalProvider, industryProvider, merchantProviders = [], customerProvider) {
        this.providers = [
            globalProvider,
            industryProvider,
            ...merchantProviders,
    ...
    async getRelevantEntries(context, query) {
...
exports.UnifiedKnowledgeBase = UnifiedKnowledgeBase;
// ── Knowledge Base Factory ──────────────────────────────────────────────────
function createKnowledgeBase(appType, merchantData, customerContext, industryCategory) {
...
// ── Helper Functions ────────────────────────────────────────────────────────
function getKnowledgeForIndustry(industry) {
    return KNOWLEDGE_BY_CATEGORY[industry] || GENERAL_KNOWLEDGE;
}
function getKnowledgeForAppType(appType) {
