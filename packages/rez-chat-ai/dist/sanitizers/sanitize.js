...
exports.defaultSanitizer = exports.DataSanitizer = exports.transactionSanitizer = exports.idSanitizer = exports.phoneSanitizer = exports.emailSanitizer = exports.cardNumberSanitizer = exports.sensitiveDataSanitizer = void 0;
...
// ── Sanitizers ─────────────────────────────────────────────────────────────────
exports.sensitiveDataSanitizer = {
...
exports.cardNumberSanitizer = {
    name: 'cardNumberSanitizer',
    sanitize: (text) => {
        return text.replace(/\b(\d{4})[- ]?(\d{4})[- ]?(\d{4})[- ]?(\d{4})\b/g, '****-****-****-$4');
    }
};
exports.emailSanitizer = {
    name: 'emailSanitizer',
    sanitize: (text) => {
...
exports.phoneSanitizer = {
    name: 'phoneSanitizer',
    sanitize: (text) => {
        return text.replace(/\b(\d{3})[- ]?(\d{3})[- ]?(\d{4})\b/g, '***-***-$3');
    }
};
exports.idSanitizer = {
    name: 'idSanitizer',
...
// ── Default Instance ─────────────────────────────────────────────────────────────
exports.defaultSanitizer = new DataSanitizer();
function sanitizeCustomerContext(context) {
    const { customerId, email, phone, cardNumbers, passwords, tokens, apiKeys, ...safeData } = context;
    return {
        name: safeData.name,
        tier: safeData.tier,
