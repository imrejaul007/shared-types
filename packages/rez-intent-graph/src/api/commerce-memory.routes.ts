 ...
 * Used by Support Provider
 */
router.post('/offer/send', async (req: Request, res: Response) => {
  try {
 ...
 */
router.get('/collaborative/:userId', async (req: Request, res: Response) => {
  try {
    const { userId } = req.params;
...
function generateRecommendations(
  activeIntents: Array<{ intentKey: string; category: string; confidence: unknown }>,
  dormantIntents: Array<{ intentKey: string; category: string; revivalScore: unknown }>
): string[] {
